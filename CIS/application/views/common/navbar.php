    <nav class="bg-white border-gray-200 dark:border-gray-600 dark:bg-gray-900">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MB7.</span>
            </a>
        ...
        <div id="mega-menu-full-dropdown" class="mt-1 border-gray-200 shadow-xs bg-gray-50 md:bg-white border-y dark:bg-gray-800 dark:border-gray-600">
            <div class="grid max-w-screen-xl px-4 py-5 mx-auto text-gray-900 dark:text-white sm:grid-cols-2 md:px-6">
                <ul>
                    <li>
                        <a href="#" class="block p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700" data-modal-target="request-modal" data-modal-toggle="request-modal">
                            <div class="font-semibold">Request.</div>
                            <span class="text-sm text-gray-500 dark:text-gray-400">Create request details.</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="block p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700" data-modal-target="cheque-modal" data-modal-toggle="cheque-modal">
                            <div class="font-semibold">Cheque.</div>
                            <span class="text-sm text-gray-500 dark:text-gray-400">Create cheque details.</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="block p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700" data-modal-target="noncheque-modal" data-modal-toggle="noncheque-modal">
                            <div class="font-semibold">Non Cheque.</div>
                            <span class="text-sm text-gray-500 dark:text-gray-400">Create non-cheque details.</span>
                        </a>
                    </li>
                </ul>
                <ul>
