    ...
    <div class="row">
        <div class="col-12">
            <div class="card" style="border-radius: 0px; border-color: transparent; background-color: transparent;">
                <div class="card-body">
                    <h1 class="text-center" style="letter-spacing: -1px; text-transform: uppercase;"><i class="fa-solid fa-box-archive" style="color: rgb(156, 12, 12);"></i> Online Archives</h1>
                    <div class="row">
                        <div class="col-md-8">
                            <div style="margin: .5em;">
                                <i id="btnDownload" class="fa-solid fa-download" style="color: rgb(156, 12, 12); font-size: 20pt;"></i>
                                Download
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="input-group">
                                <div class="form-floating mb-3">
                                    <input type="search" name="txtnmSearch" class="form-control" id="idnmSearch" placeholder="name@example.com">
                                    <label for="idnmSearch">Search</label>
                                </div>
                                <i id="btnSearch" class="fa-solid fa-magnifying-glass" style="color: rgb(156, 12, 12); font-size: 20pt; margin: .5em;"></i>
                            </div>
                        </div>
                    </div>
                    <div class="card" style="overflow-y: scroll; height: 450px; scrollbar-width: thin; scrollbar-color: #828282 #e6e8e6; border-radius: 0px; border-color: transparent; background-color: transparent; box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;">
                        <table id="idtblArchives" class="table table-warning table-hover table-striped" style="border-color: transparent; border-radius: 0px; zoom: 80%;">
